...
from autora.experiment_runner.synthetic.generator.equation_sampler.equation_tree import EquationTree
...
def test_sampler():
    ...
    for i in range(10):
        sampler = EquationTree(tree_structure, feature_space, function_space, operation_space)
        root = sampler.sample_valid()
        expr = sampler.expr
        num_x = sampler.num_x
